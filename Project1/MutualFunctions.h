...
void EditDetailsInDb(const char* what, const char* newWhat,const char* dbNmae,const char* tableName,const char* id);//gets what to edit, to what to edit it and where to edit it and edits it in a db

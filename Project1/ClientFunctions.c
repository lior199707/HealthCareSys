...
void clientMenu()
{
	...
	while (exitFlag)
	{
		...
		{
			puts("User login menu");
			clientLogIN();
			break;
		}
		case 2: //user register
		{
			puts("user register menu");
			clientRegister();
			break;
		}
